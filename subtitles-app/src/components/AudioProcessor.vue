    ...
    <div class="bg-white overflow-hidden shadow-md rounded-xl border border-gray-200">
      ...
      <div class="bg-indigo-700 px-6 py-4">
        <div class="flex items-center">
          ...
          <div class="ml-3">
            <h2 class="text-xl font-bold text-white">Audio Transcription Tool</h2>
      ...
      <div class="px-6 py-6 sm:p-8">
        ...
        <div class="mb-8 bg-gray-50 p-4 rounded-lg border border-gray-200">
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <label for="api-key" class="block text-sm font-medium text-gray-700 mb-2 sm:mb-0">
              AssemblyAI API Key
            </label>
            <div
        ...
        <div class="mb-8">
          <div class="flex justify-between items-center mb-2">
            <label class="block text-sm font-medium text-gray-700"> Upload Audio File </label>
          ...
          >
            <div class="p-6 text-center" v-if="!audioFile">
              ...
              <div class="flex flex-col items-center mt-4 space-y-1">
                ...
                <p class="text-xs text-gray-500">MP3, WAV, M4A, and other audio formats</p>
              </div>
            </div>
        ...
        <div class="mb-8">
            ...
            >
              ...
              <label for="transcript" class="flex items-center cursor-pointer">
                ...
                <div>
                  ...
                  <p class="text-xs text-gray-500">Plain text format without timestamps (.txt)</p>
                </div>
              </label>
            </div>
            ...
            >
              ...
              <label for="subtitles" class="flex items-center cursor-pointer">
                ...
                <div>
                  ...
                  <p class="text-xs text-gray-500">Timed subtitles format (.srt)</p>
                </div>
              </label>
            </div>
          </div>
          ...
          >
            <label for="character-length" class="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div class="flex items-center">
              ...
              />
              <span class="ml-2 text-sm text-gray-500">characters per line</span>
            </div>
        ...
        <div v-if="isLoading" class="mb-8">
          <div class="flex items-center justify-between mb-2">
            <div class="text-sm font-medium text-gray-700">{{ processingStage }}</div>
        ...
        <div class="mt-6 space-y-4">
          <!-- Error Message -->
          <div v-if="errorMessage" class="rounded-lg bg-red-50 p-4 border border-red-100">
            <div class="flex">
              <div class="flex-shrink-0">
                <svg
          ...
          <!-- Success Message -->
          <div v-if="successMessage" class="rounded-lg bg-green-50 p-4 border border-green-100">
            <div class="flex">
              <div class="flex-shrink-0">
                <svg
